...
test(`Learn Playwright Locators`,async ({page}) => {
    ...
    // await page.getByRole("textbox",{name:"Username"}).fill("dilipkumar.rajendran@testleaf.com");//username

     await page.getByLabel("Username",{exact:true}).fill("dilipkumar.rajendran@testleaf.com");//username

    //await page.getByRole("textbox",{name:"Password"}).fill("TestLeaf@2025")//password
